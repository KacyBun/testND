            ...
            createTemplate: function(args) {
                ...
                if (showPrevious || showPageNumbers || showNext) {
                    ...
                    if (showPrevious) {
                        if (currentPage === 1) {
                            if (!autoHidePrevious) {
                                html += '<li class="'+ classPrefix +'-prev '+ disableClassName +' btn btn-success"><a href="">'+ prevText +'<\/a><\/li>';
                            }
                        }
                        else{
                            html += '<li class="'+ classPrefix +'-prev J-paginationjs-previous btn btn-success" data-num="'+ (currentPage - 1) +'" title="Previous page"><a href="'+ pageLink +'">'+ prevText +'<\/a><\/li>';
                        }
                    }
                    ...
                    if (showPageNumbers) {
                        if (rangeStart <= 3) {
                            for(i = 1; i < rangeStart; i++) {
                                if (i == currentPage) {
                                    html += '<li class="'+ classPrefix +'-page J-paginationjs-page '+ activeClassName +' btn btn-success" data-num="'+ i +'"><a href="">'+ i +'<\/a><\/li>';
                                }
                                else{
                                    html += '<li class="'+ classPrefix +'-page J-paginationjs-page btn btn-success" data-num="'+ i +'"><a href="'+ pageLink +'">'+ i +'<\/a><\/li>';
                                }
                            }
                        }
                        else{
                            if (attributes.showFirstOnEllipsisShow) {
                                html += '<li class="'+ classPrefix +'-page '+ classPrefix +'-first J-paginationjs-page btn btn-success" data-num="1"><a href="'+ pageLink +'">1<\/a><\/li>';
                            }

                            html += '<li class="'+ classPrefix +'-ellipsis '+ disableClassName +' btn btn-success"><a href="">'+ ellipsisText +'<\/a><\/li>';
                        }
                        ...
                        if (rangeEnd >= totalPage - 2) {
                            ...
                            if (attributes.showLastOnEllipsisShow) {
                                html += '<li class="'+ classPrefix +'-page '+ classPrefix +'-last J-paginationjs-page btn btn-success" data-num="'+ totalPage +'"><a href="'+ pageLink +'">'+ totalPage +'<\/a><\/li>';
                            }
                        }
                    }
                    ...
                    if (showNext) {
                        if (currentPage == totalPage) {
                            if (!autoHideNext) {
                                html += '<li class="'+ classPrefix +'-next '+ disableClassName +' btn btn-success"><a href="">'+ nextText +'<\/a><\/li>';
                            }
                        }
                        else{
                            html += '<li class="'+ classPrefix +'-next J-paginationjs-next btn btn-success" data-num="'+ (currentPage + 1) +'" title="Next page"><a href="'+ pageLink +'">'+ nextText +'<\/a><\/li>';
                        }
                    }
